...
const Signup=()=>{
    ...
    const post=()=>{
         const registration={firstName,lastName,password,email}
        ...
        <Card className="bg-slate-800 object-cover h-full w-full grid grid-cols-1 flex-col justify-items-center mt-16 " color="transparent" shadow={false}>
            ...
            <form action="Summit" className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96  text-white">
                ...
                <Checkbox
                    ...
                    onClick={validate}
                    containerProps={{ className: "-ml-2.5 bg" }}
                />
                <Button className="mt-6 bg-indigo-600  py-2 text-indigo-100 hover:bg-[#ce8fc3] hover:shadow-md duration-75" 
                        fullWidth
