...
const Footer=()=>{
    ...
    return(
        <div className=" w-full flex">
            ...
            <footer class="w-full text-white bg-gray-100 body-font">
        <div
            class="container flex flex-col flex-wrap px-5 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
            <div class="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
                <img src="https://img.icons8.com/ios/50/null/housekeeper-female.png"/>
                <p class="mt-2 text-sm text-gray-500">Clean and perfection is our moto!</p>
                <div class="mt-4">
        ...
        <div class="bg-gray-300">
            <div class="container px-5 py-4 mx-auto">
                <p class="text-sm text-gray-700 capitalize xl:text-center text-center">© {year} All rights reserved </p>
            </div>
        </div>
    </footer>
